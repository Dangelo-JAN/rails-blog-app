...
RSpec.describe Post, type: :model do
  before :each do
    @user = User.new(name: 'John Doe', photo: 'https://example.com/photo.jpg', bio: 'hola', posts_counter: 1)
  end

  subject { Post.new(author: @user, title: 'Post title1', text: 'text1', comments_counter: 1, likes_counter: 1) }
